...
É o processo de organização, limpeza e estruturação dos dados. Normalmente, é um dos procedimentos mais trabalhosos, e acontece quando os dados apresentam informações incorretas para algumas observações (exemplos), ou quando faltam informações para alguns indivíduos ou para algumas variáveis. Além disso, as tabelas, muitas vezes, não estão estruturadas no modelo padrão, onde as linhas representam os indivíduos ou exemplos e as colunas configuram as variáveis ou características.  
